...
const PostViewerIntroduce = ({ closed }) => {
  return (
    <>
      <PostViewerIntroduceBlock closed={closed === true ? 1 : 0}>
          ...
          <Block>
            <CallBlock>
              ...
              <Text fontSize={20} fontWeight={500}>
                <span style={{ color: 'orange' }}> 전화/카톡 </span>으로
                진행합니다.
              </Text>
            </CallBlock>
            <Text fontSize={16}>
              구체적인 날짜/시간은 베테랑과 협의해주세요!
            </Text>
          </Block>
        )}
        <Padding />
        ...
        <Text fontWeight={500}>
          ...
          달성한 사장입니다. ^^* 치킨집 운영에 관심있으신 분들, 요즘 배달
          수수료는 어떤지~ 닭 처음 튀겨보던 때로 돌아가서 질문 다~ 받아드립니다.
          ^^
        </Text>
